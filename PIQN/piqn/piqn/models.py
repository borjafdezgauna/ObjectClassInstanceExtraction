...
class EntityAwareBertSelfAttention(nn.Module):
    ...
    def forward(self, token_hidden_states, entity_hidden_states, attention_mask, query_pos = None):
        ...
        #Changed this to avoid nan numbers in this layer (Bortx 2025-03-06)
        attention_probs = F.log_softmax(attention_scores, dim= -1)#F.softmax(attention_scores, dim=-1)
        attention_probs = torch.exp(attention_probs)
